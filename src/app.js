    ...
    User.findOne({ username: req.body.username })
        .then((user) => {
            if (user) {
                ...
                const cleanedPhoneNum = req.body.phoneNum.replace(/\s/g, '');

                const formattedPhoneNum = "+55" + cleanedPhoneNum;
...
app.post("/addTask", (req, res) => {
    ...
    if (!isNaN(minutesToReminder)) {
        ...
        console.log("The task: "  + req.body.description + " will be sent at " + reminderTime)
